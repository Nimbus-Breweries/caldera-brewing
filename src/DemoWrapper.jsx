      ...
      {isAdmin ? (
        ...
        <div className="demo-center" style={{
          ...
          <div style={{
            ...
            background: "#0a0a0a",
            borderRadius: 52,
            boxShadow: "0 0 0 1px #1a1a1a, 0 40px 100px rgba(0,0,0,.9), 0 12px 40px rgba(0,0,0,.7), 0 0 80px rgba(160,90,20,0.5), 0 0 160px rgba(160,90,20,0.25), inset 0 1px 0 rgba(255,255,255,.08)",
            padding: 12,
            flexShrink: 0,
          }}>
            {/* Power button */}
